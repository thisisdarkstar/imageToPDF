...
import io.github.thisisdarkstar.imagetopdf.model.FilterType
import io.github.thisisdarkstar.imagetopdf.model.ImageQuality
import io.github.thisisdarkstar.imagetopdf.model.PageItem
import io.github.thisisdarkstar.imagetopdf.model.PageMargin
import io.github.thisisdarkstar.imagetopdf.model.PageOrientation
...
import io.github.thisisdarkstar.imagetopdf.model.WatermarkColor
import io.github.thisisdarkstar.imagetopdf.model.WatermarkConfig
import io.github.thisisdarkstar.imagetopdf.model.WatermarkPreset
...
class ModelAndLogicTest {
    ...
    fun testThemeModeTransitions() {
        ...
        val modes = io.github.thisisdarkstar.imagetopdf.theme.ThemeMode.values()
        assertEquals(3, modes.size)
        assertTrue(modes.contains(io.github.thisisdarkstar.imagetopdf.theme.ThemeMode.SYSTEM))
        assertTrue(modes.contains(io.github.thisisdarkstar.imagetopdf.theme.ThemeMode.LIGHT))
        assertTrue(modes.contains(io.github.thisisdarkstar.imagetopdf.theme.ThemeMode.DARK))

        // Verify toggle transition logic:
        // From SYSTEM -> DARK
        val nextFromSystem = when (io.github.thisisdarkstar.imagetopdf.theme.ThemeMode.SYSTEM) {
            io.github.thisisdarkstar.imagetopdf.theme.ThemeMode.LIGHT -> io.github.thisisdarkstar.imagetopdf.theme.ThemeMode.DARK
            io.github.thisisdarkstar.imagetopdf.theme.ThemeMode.DARK -> io.github.thisisdarkstar.imagetopdf.theme.ThemeMode.LIGHT
            io.github.thisisdarkstar.imagetopdf.theme.ThemeMode.SYSTEM -> io.github.thisisdarkstar.imagetopdf.theme.ThemeMode.DARK
        }
        assertEquals(io.github.thisisdarkstar.imagetopdf.theme.ThemeMode.DARK, nextFromSystem)

        // From DARK -> LIGHT
        val nextFromDark = when (io.github.thisisdarkstar.imagetopdf.theme.ThemeMode.DARK) {
            io.github.thisisdarkstar.imagetopdf.theme.ThemeMode.LIGHT -> io.github.thisisdarkstar.imagetopdf.theme.ThemeMode.DARK
            io.github.thisisdarkstar.imagetopdf.theme.ThemeMode.DARK -> io.github.thisisdarkstar.imagetopdf.theme.ThemeMode.LIGHT
            io.github.thisisdarkstar.imagetopdf.theme.ThemeMode.SYSTEM -> io.github.thisisdarkstar.imagetopdf.theme.ThemeMode.DARK
        }
        assertEquals(io.github.thisisdarkstar.imagetopdf.theme.ThemeMode.LIGHT, nextFromDark)

        // From LIGHT -> DARK
        val nextFromLight = when (io.github.thisisdarkstar.imagetopdf.theme.ThemeMode.LIGHT) {
            io.github.thisisdarkstar.imagetopdf.theme.ThemeMode.LIGHT -> io.github.thisisdarkstar.imagetopdf.theme.ThemeMode.DARK
            io.github.thisisdarkstar.imagetopdf.theme.ThemeMode.DARK -> io.github.thisisdarkstar.imagetopdf.theme.ThemeMode.LIGHT
            io.github.thisisdarkstar.imagetopdf.theme.ThemeMode.SYSTEM -> io.github.thisisdarkstar.imagetopdf.theme.ThemeMode.DARK
        }
        assertEquals(io.github.thisisdarkstar.imagetopdf.theme.ThemeMode.DARK, nextFromLight)
    }
}
